...
export default class MobileNav extends Component {
    ...
    render() {
        ...
        <Link to="/lawyer/fr/#home" className="menu-item"> Home </Link>
        <Link to="/lawyer/fr/#Features" className="menu-item">Features</Link>
        <Link to="/lawyer/fr/#benefits" className="menu-item">Benefits</Link>
        <Link to="/lawyer/fr/#team" className="menu-item">Team</Link>
        <Link to="/lawyer/fr/#contact" className="menu-item">Contact</Link>
