      ...
      <NavbarToggler onClick={this.toggleNavbar} className="mr-2" />
          <Collapse isOpen={!this.state.collapsed} navbar className="d-flex justify-content-end">
            <Nav id="#navbarNavDropdown">
              <NavItem>
                <Link to="/lawyer/fr/#home" onClick={this.handleClick} className="nav-link active"> Accueil </Link>
              </NavItem>
              <NavItem>
                <Link to="/lawyer/fr/#Features" onClick={this.handleClick} className="nav-link">Caractéristiques</Link>
              </NavItem>
              <NavItem>
                <Link to="/lawyer/fr/#benefits" onClick={this.handleClick} className="nav-link">Avantages</Link>
              </NavItem>
              <NavItem>
                <Link to="/lawyer/fr/#team" onClick={this.handleClick} className="nav-link">Équipe</Link>
              </NavItem>
              <NavItem>
                <Link to="/lawyer/fr/#contact" onClick={this.handleClick} className="nav-link">Contact</Link>
              </NavItem>
              <NavItem>
                <Link to="/blog/fr" className="nav-link"> Blog </Link>
              </NavItem>
              <NavItem>
                <Link to="/FAQ/fr" className="nav-link"> FAQ </Link>
              </NavItem>
              <NavItem>
