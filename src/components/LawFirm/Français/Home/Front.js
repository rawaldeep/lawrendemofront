    ...
    return (
        ...
        <div className="row">
          ...
          <div className="col-md-6 header">
            <h1 className="cover-heading pb-2">Les Chatbots AI <br/>légaux aident les avocats <br/>à travailler plus efficacement
                </h1>
            {/* <img src={require("../images/1.png")} className="logo" /> */}
            {/* <Typer/> */}
            <p className="lead">Lawren.io automatise les tâches répétitives dans votre cabinet d'avocats, vous économisant en moyenne 455 heures et 57.000 euros*</p>
            <p className="lead pt-4">
              <a href="#contact" className="btn btn-lg btn-light pl-5 pr-5"> Réservez la démo </a>
              <Link to="/lawyer/fr/#calculate" className="btn btn-lg btn-light">Calculez vos avantages</Link>
            </p>
            <p>*basé sur un cabinet de cinq avocats</p>
          </div>
          <div className="col-md-6 header">
            {/* <Video url={video}/> */}
            <Animation/>
