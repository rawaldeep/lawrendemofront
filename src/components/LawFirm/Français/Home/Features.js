          ...
          <div className="col-md-12">
            <div className="row featurecards p-3 pr-5 text-center">
              <div className="col-md-3 card" style={{width: '18rem'}}>
                ...
                <div className="card-header cardhead"><strong>Assistant Chatbot</strong></div>
                {/* <img class="card-img-top" src="./images/7fd84e1d-134a-40e5-a071-45aab492e4b3.jpg" alt="Card image cap"> */}
                <div className="card-body">
                  <h6 className="card-title text-left"><strong>Automatisez l'accueil des clients et soyez prêt pour une 1ère rencontre</strong>
                  </h6>
              ...
              <div className="col-md-3 card" style={{width: '18rem'}}>
                <div className="card-img-top" />
                <div className="card-header cardhead"><strong>Contrat chatbot</strong></div>
                <div className="card-body">
                  <h6 className="card-title text-left"><strong>Génération de documents impliquant votre client</strong></h6>
              ...
              <div className="col-md-3 card" style={{width: '18rem'}}>
                <div className="card-img-top" />
                <div className="card-header cardhead"><strong>Moteur de recherche juridique ML</strong></div>
                <div className="card-body">
                  <h6 className="card-title text-left"><strong>Les résultats de la recherche juridique immédiatement à portée de main</strong></h6>
