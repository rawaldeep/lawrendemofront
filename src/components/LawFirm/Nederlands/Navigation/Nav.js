      ...
      <NavbarToggler onClick={this.toggleNavbar} className="mr-2" />
          <Collapse isOpen={!this.state.collapsed} navbar className="d-flex justify-content-end">
            <Nav id="#navbarNavDropdown">
              <NavItem>
                <Link to="/lawyer/nl/#home" onClick={this.handleClick} className="nav-link active"> Home </Link>
              </NavItem>
              <NavItem>
                <Link to="/lawyer/nl/#Features" onClick={this.handleClick} className="nav-link">Kenmerken</Link>
              </NavItem>
              <NavItem>
                <Link to="/lawyer/nl/#benefits" onClick={this.handleClick} className="nav-link">Voordelen</Link>
              </NavItem>
              <NavItem>
                <Link to="/lawyer/nl/#team" onClick={this.handleClick} className="nav-link">Team</Link>
              </NavItem>
              <NavItem>
                <Link to="/lawyer/nl/#contact" onClick={this.handleClick} className="nav-link">Contact</Link>
              </NavItem>
              <NavItem>
                <Link to="/blog/nl" className="nav-link"> Blog </Link>
              </NavItem>
              <NavItem>
                <Link to="/FAQ/nl" className="nav-link"> FAQ </Link>
              </NavItem>
              <NavItem>
                <Link className="nav-link calculate" onClick={this.handleClick} to="/lawyer/nl/#calculate">Bereken uw voordelen</Link>
              </NavItem>
              <NavItem className="sl-nav">
                <div className="nav-link">
              <ul>
                 <li><Link className="inner-link" to="/usecase/nl/">Usecases</Link>
