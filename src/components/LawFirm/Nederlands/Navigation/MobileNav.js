...
export default class MobileNav extends Component {
    ...
    render() {
        ...
        <Link to="/lawyer/nl/#home" className="menu-item"> Home </Link>
        <Link to="/lawyer/nl/#Features" className="menu-item">Features</Link>
        <Link to="/lawyer/nl/#benefits" className="menu-item">Benefits</Link>
        <Link to="/lawyer/nl/#team" className="menu-item">Team</Link>
