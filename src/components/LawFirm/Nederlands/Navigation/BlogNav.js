      ...
      <NavbarToggler onClick={this.toggleNavbar} className="mr-2" />
          <Collapse isOpen={!this.state.collapsed} navbar className="d-flex justify-content-end">
            <Nav id="#navbarNavDropdown">
              <NavItem>
                <Link to="/lawyer/nl" className="nav-link"> Home </Link>
              </NavItem>
              <NavItem>
                <NavLink href="/lawyer/nl/#Features">Kenmerken</NavLink>
              </NavItem>
              <NavItem>
                <NavLink href="/lawyer/nl/#benefits">Voordelen</NavLink>
              </NavItem>
              <NavItem>
                <NavLink href="lawyer/nl/#team">Team</NavLink>
              </NavItem>
              <NavItem>
                <NavLink href="/lawyer/nl/#contact">Contact</NavLink>
              </NavItem>
              <NavItem>
                <Link to="/blog/nl" onClick={this.handleChange} className="nav-link"> Blog </Link>
              </NavItem>
              <NavItem>
                <Link to="/FAQ/nl" onClick={this.handleChange} className="nav-link"> FAQ </Link>
              </NavItem>
              <NavItem>
              <Link className="nav-link calculate" to="/lawyer/nl/#calculate">Bereken uw voordelen</Link>
              </NavItem>
