        ...
        <div className={`${envolope}`}>
          ...
          <form className="contact100-form validate-form">
            ...
            <div className="wrap-input100 validate-input" data-validate="Name is required">
              <input className="input100" type="text" name="name" placeholder="Naam" value={this.state.name} onChange={event => this.changeValue(event)} />
            ...
            <div className="wrap-input100 validate-input" data-validate="Message is required">
              <textarea className="input100" name="message" placeholder="Bericht" defaultValue={this.state.message} onChange={event => this.changeValue(event)} />
              <span className="focus-input100" />
            </div>
