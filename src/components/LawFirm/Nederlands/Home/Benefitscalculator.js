           ...
           <div className="col-md-4">
            ...
            <div className="col-md-8 p-5">
              <div className="line pb-4">
                <h2 className="text-white">Bereken uw voordelen</h2>
              </div>
              <p className="lead text-white">Vul de onderstaande informatie in en bereken hoeveel <strong>tijd</strong> u kunt <strong>besparen</strong> en hoeveel <strong>extra omzet</strong> u kunt genereren.</p>
            </div>
              ...
              <form className="container">
                <div className="form-row d-flex justify-content-between">
                  <div className="col-md-3 box p-4 card">
                    <p className="text-center">Aantal nieuwe klanten / maand</p>
                  ...
                  <div className="col-md-3 box p-4 card">
                    <p className="text-center"> <span style={{color: 'rgba(84, 100, 113, 0.5)'}}>Indien toepasselijk</span><br />
                    Bedrag van nieuwe contracten op te stellen/maand</p>
                    <div className="card-body">
                      <button type="button" id="moins" 
                      name="contracts"
                    onClick={clientMinus}
                  ...
                  <div className="col-md-6 box p-4 card">
                    <p className="text-center">Uurtarief</p>
                    <div className="card-body">
                      <div className="col">
                ...
                <div className="form-row pt-3 pb-3">
                  <div className="col-md-8 companyData">
                    <div className="form-row"><input type="text" placeholder="Voer bedrijfsnaam in" name="company" onChange={handleInputChange} value={state.company}/></div>
                    <div className="form-row"><input type="text" placeholder="Vul email adres in" name="email" onChange={handleInputChange} value={state.email} /></div>
                  </div>
                  ...
                  <span className="personalizedreport">Ontvang mijn persoonlijk rapport</span>
              </button>
