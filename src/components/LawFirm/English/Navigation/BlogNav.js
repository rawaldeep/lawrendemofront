      ...
      <NavbarToggler onClick={this.toggleNavbar} className="mr-2" />
          <Collapse isOpen={!this.state.collapsed} navbar className="d-flex justify-content-end">
            <Nav id="#navbarNavDropdown">
              <NavItem>
                <Link to="/lawyer/en" className="nav-link"> Home </Link>
              </NavItem>
              <NavItem>
                <NavLink href="/lawyer/en/#Features">Features</NavLink>
              </NavItem>
              <NavItem>
                <NavLink href="/lawyer/en/#benefits">Benefits</NavLink>
              </NavItem>
              <NavItem>
                <NavLink href="lawyer/en/#team">Team</NavLink>
              </NavItem>
              <NavItem>
                <NavLink href="/lawyer/en/#contact">Contact</NavLink>
              </NavItem>
              <NavItem>
                <Link to="/blog/en" onClick={this.handleChange} className="nav-link"> Blog </Link>
              </NavItem>
              <NavItem>
                <Link to="/FAQ/en" onClick={this.handleChange} className="nav-link"> FAQ </Link>
              </NavItem>
              <NavItem>
              <Link className="nav-link calculate" to="/lawyer/en/#calculate">Calculate Your Benefits</Link>
              </NavItem>
