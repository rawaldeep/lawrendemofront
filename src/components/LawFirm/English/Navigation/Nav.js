      ...
      <NavbarToggler onClick={this.toggleNavbar} className="mr-2" />
          <Collapse isOpen={!this.state.collapsed} navbar className="d-flex justify-content-end">
            <Nav id="#navbarNavDropdown">
              <NavItem>
                <Link to="/lawyer/en/#home" onClick={this.handleClick} className="nav-link active"> Home </Link>
              </NavItem>
              <NavItem>
                <Link to="/lawyer/en/#Features" onClick={this.handleClick} className="nav-link">Features</Link>
              </NavItem>
              <NavItem>
                <Link to="/lawyer/en/#benefits" onClick={this.handleClick} className="nav-link">Benefits</Link>
              </NavItem>
              <NavItem>
                <Link to="/lawyer/en/#team" onClick={this.handleClick} className="nav-link">Team</Link>
              </NavItem>
              <NavItem>
                <Link to="/lawyer/en/#contact" onClick={this.handleClick} className="nav-link">Contact</Link>
              </NavItem>
              <NavItem>
                <Link to="/blog/en" className="nav-link"> Blog </Link>
              </NavItem>
              <NavItem>
                <Link to="/FAQ/en" className="nav-link"> FAQ </Link>
              </NavItem>
              <NavItem>
                <Link className="nav-link calculate" onClick={this.handleClick} to="/lawyer/en/#calculate">Calculate Your Benefits</Link>
              </NavItem>
              <NavItem className="sl-nav">
                <div className="nav-link">
              <ul>
                 <li><Link className="inner-link" to="/usecase/en/">Usecases</Link>
