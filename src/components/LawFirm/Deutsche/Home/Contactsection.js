        ...
        <div className={`${envolope}`}>
          ...
          <form className="contact100-form validate-form">
            ...
            <div className="wrap-input100 validate-input" data-validate="Name is required">
              <input className="input100" type="text" name="name" placeholder="Name" value={this.state.name} onChange={event => this.changeValue(event)} />
            ...
            <div className="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
              <input className="input100" type="text" name="email" placeholder="Email" value={this.state.email} onChange={event => this.changeValue(event)} />
              <span className="focus-input100" />
              <span className="symbol-input100">
            ...
            <div className="wrap-input100 validate-input" data-validate="Message is required">
              <textarea className="input100" name="message" placeholder="Nachricht" defaultValue={this.state.message} onChange={event => this.changeValue(event)} />
              <span className="focus-input100" />
            </div>
