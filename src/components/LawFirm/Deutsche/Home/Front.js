    ...
    return (
        ...
        <div className="row">
          ...
          <div className="col-md-6 header">
            <h1 className="cover-heading pb-2">Juristische KI Chatbots<br/> helfen Anwälten <br/>effizienter zu arbeiten
                {/* Legal AI Chatbots <br/> help lawyers <br/>work more efficient */}
                </h1>
            {/* <img src={require("../images/1.png")} className="logo" /> */}
            {/* <Typer/> */}
            <p className="lead">Lawren.io automatisiert {`\u00A0`} sich wiederholende Aufgaben in Ihrer Kanzlei, Sie sparen durchschnittlich 455 Stunden und 57.000 Euro .*</p>
            <p className="lead pt-4">
              <a href="#contact" className="btn btn-lg btn-light pl-5 pr-5">Buchen Sie Die Demo</a>
              <Link to="/lawyer/de/#calculate" className="btn btn-lg btn-light">Berechnen Sie Ihre Vorteile</Link>
            </p>
            <p>*basierend auf einer Anwaltskanzlei mit 5 Anwälten</p>
          </div>
          <div className="col-md-6 header">
            {/* <Video url={video}/> */}
            <Animation/>
