          ...
          <div className="col-md-12">
            <div className="row featurecards p-3 pr-5 text-center">
              <div className="col-md-3 card" style={{width: '18rem'}}>
                ...
                <div className="card-header cardhead"><strong>Chatbot-Assistent</strong></div>
                {/* <img class="card-img-top" src="./images/7fd84e1d-134a-40e5-a071-45aab492e4b3.jpg" alt="Card image cap"> */}
                <div className="card-body">
                  <h6 className="card-title text-left"><strong>Automatisieren Sie die Kundenzufuhr und bereiten Sie sich auf ein erstes Gespräch vor.</strong>
                  </h6>
              ...
              <div className="col-md-3 card" style={{width: '18rem'}}>
                <div className="card-img-top" />
                <div className="card-header cardhead"><strong>Vertrags chatbot</strong></div>
                <div className="card-body">
                  <h6 className="card-title text-left"><strong>Dokumentenerstellung unter Einbeziehung Ihres Kunden</strong></h6>
              ...
              <div className="col-md-3 card" style={{width: '18rem'}}>
                <div className="card-img-top" />
                <div className="card-header cardhead"><strong>ML Juristische Suchmaschine</strong></div>
                <div className="card-body">
                  <h6 className="card-title text-left"><strong>Juristische Suchergebnisse sofort verfügbar</strong></h6>
