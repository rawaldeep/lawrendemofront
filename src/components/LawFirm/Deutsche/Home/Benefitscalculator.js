           ...
           <div className="col-md-4">
            ...
            <div className="col-md-8 p-5">
              <div className="line pb-4">
                <h2 className="text-white">Berechnen Sie Ihre Vorteile</h2>
              </div>
              <p className="lead text-white">Füllen Sie die folgenden Felder aus und berechnen Sie, wie viel Zeit Sie sparen können und wie viel zusätzliche Einnahmen Sie erzielen können.</p>
            </div>
              ...
              <form className="container">
                <div className="form-row d-flex justify-content-between">
                  <div className="col-md-3 box p-4 card">
                    <p className="text-center">Anzahl der neuen Kunden/Monat</p>
                  ...
                  <div className="col-md-3 box p-4 card">
                    <p className="text-center"> <span style={{color: 'rgba(84, 100, 113, 0.5)'}}>Falls zutreffend</span><br />
                    Anzahl der neu zu erstellenden Verträge / Monat</p>
                    <div className="card-body">
                      <button type="button" id="moins" 
                      name="contracts"
                    onClick={clientMinus}
                  ...
                  <div className="col-md-6 box p-4 card">
                    <p className="text-center">Stundensatz</p>
                    <div className="card-body">
                      <div className="col">
                ...
                <div className="form-row pt-3 pb-3">
                  <div className="col-md-8 companyData">
                    <div className="form-row"><input type="text" placeholder="Firmenname eingeben" name="company" onChange={handleInputChange} value={state.company}/></div>
                    <div className="form-row"><input type="text" placeholder="E-Mail-Adresse eingeben" name="email" onChange={handleInputChange} value={state.email} /></div>
                  </div>
                  ...
                  <span className="personalizedreport">Meinen persönlichen Bericht erhalten</span>
              </button>
