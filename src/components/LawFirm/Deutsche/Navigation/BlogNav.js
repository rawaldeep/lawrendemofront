      ...
      <NavbarToggler onClick={this.toggleNavbar} className="mr-2" />
          <Collapse isOpen={!this.state.collapsed} navbar className="d-flex justify-content-end">
            <Nav id="#navbarNavDropdown">
              <NavItem>
                <Link to="/lawyer/de/" className="nav-link"> Startseite </Link>
              </NavItem>
              <NavItem>
                <NavLink href="/lawyer/de/#Features">Merkmale</NavLink>
              </NavItem>
              <NavItem>
                <NavLink href="/lawyer/de//#benefits">Vorteile</NavLink>
              </NavItem>
              <NavItem>
                <NavLink href="lawyer/de/#team">Team</NavLink>
              </NavItem>
              <NavItem>
                <NavLink href="/lawyer/de/#contact">Kontakt</NavLink>
              </NavItem>
              <NavItem>
                <Link to="/blog/de" onClick={this.handleChange} className="nav-link"> Blog </Link>
              </NavItem>
              <NavItem>
                <Link to="/FAQ/de" onClick={this.handleChange} className="nav-link"> FAQ </Link>
              </NavItem>
              <NavItem>
              <Link className="nav-link calculate" to="/lawyer/de/#calculate">Berechnen Sie Ihren Vorteile</Link>
              </NavItem>
