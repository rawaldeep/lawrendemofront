...
export default class MobileNav extends Component {
    ...
    render() {
        ...
        <Link to="/lawyer/de/#home" className="menu-item"> Home </Link>
        <Link to="/lawyer/de/#Features" className="menu-item">Features</Link>
        <Link to="/lawyer/de/#benefits" className="menu-item">Benefits</Link>
        <Link to="/lawyer/de/#team" className="menu-item">Team</Link>
        <Link to="/lawyer/de/#contact" className="menu-item">Contact</Link>
