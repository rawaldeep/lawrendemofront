...
export default function Front() {
    const [state, setState] = useState({ 
     ...
     useEffect(() => {
      ...
      response.map( item => {
        let word = item.title.rendered.search("Legal Department");
        if(word !== -1){
          setState({
              loading: false,
    ...
    return (
        ...
        <div className="row">
          ...
          <div className="col-md-6 header">
            ...
            {/* <Typer/> */}
            <p className="lead">Lawren.io automatisiert {`\u00A0`} sich wiederholende Aufgaben in Ihrer rechtsabteilung.</p>
            <p className="lead pt-4">
              <a href="#contact" className="btn btn-lg btn-light pl-5 pr-5">Buchen Sie Die Demo</a>
              <Link to="/legaldepartment/usecase/de/" className="btn btn-lg btn-light">Usecases</Link>
            </p>
