      ...
      <NavbarToggler onClick={this.toggleNavbar} className="mr-2" />
          <Collapse isOpen={!this.state.collapsed} navbar className="d-flex justify-content-end">
            <Nav id="#navbarNavDropdown">
              <NavItem>
                <Link to="/legaldepartment/de/#home" onClick={this.handleClick} className="nav-link active"> Startseite </Link>
              </NavItem>
              <NavItem>
                <Link to="/legaldepartment/de/#Features" onClick={this.handleClick} className="nav-link">Merkmale</Link>
              </NavItem>
              <NavItem>
                <Link to="/legaldepartment/de/#benefits" onClick={this.handleClick} className="nav-link">Vorteile</Link>
              </NavItem>
              <NavItem>
                <Link to="/legaldepartment/de/#team" onClick={this.handleClick} className="nav-link">Team</Link>
              </NavItem>
              <NavItem>
                <Link to="/legaldepartment/de/#contact" onClick={this.handleClick} className="nav-link">Kontakt</Link>
              </NavItem>
              <NavItem>
                <Link to="/legaldepartment/blog/de" className="nav-link"> Blog </Link>
              </NavItem>
              <NavItem>
                <Link to="/legaldepartment/FAQ/de" className="nav-link"> FAQ </Link>
              </NavItem>
              {/* <NavItem>
                <Link className="nav-link calculate" onClick={this.handleClick} to="/legaldepartment/de/#calculate">Berechnen Sie Ihren Vorteile</Link>
              </NavItem> */}
              <NavItem className="sl-nav">
                <div className="nav-link">
              <ul>
                 <li><Link className="inner-link" to="/legaldepartment/usecase/de/">Usecases</Link>
