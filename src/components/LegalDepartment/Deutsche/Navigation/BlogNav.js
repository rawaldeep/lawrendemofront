      ...
      <NavbarToggler onClick={this.toggleNavbar} className="mr-2" />
          <Collapse isOpen={!this.state.collapsed} navbar className="d-flex justify-content-end">
            <Nav id="#navbarNavDropdown">
              <NavItem>
                <Link to="/legaldepartment/de/" className="nav-link"> Startseite </Link>
              </NavItem>
              <NavItem>
                <NavLink href="/legaldepartment/de/#Features">Merkmale</NavLink>
              </NavItem>
              <NavItem>
                <NavLink href="/legaldepartment/de//#benefits">Vorteile</NavLink>
              </NavItem>
              <NavItem>
                <NavLink href="/legaldepartment/de/#team">Team</NavLink>
              </NavItem>
              <NavItem>
                <NavLink href="/legaldepartment/de/#contact">Kontakt</NavLink>
              </NavItem>
              <NavItem>
                <Link to="/legaldepartment/blog/de" onClick={this.handleChange} className="nav-link"> Blog </Link>
              </NavItem>
              <NavItem>
                <Link to="/legaldepartment/FAQ/de" onClick={this.handleChange} className="nav-link"> FAQ </Link>
              </NavItem>
              {/* <NavItem>
              <Link className="nav-link calculate" to="/legaldepartment/de/#calculate">Berechnen Sie Ihren Vorteile</Link>
              </NavItem> */}
