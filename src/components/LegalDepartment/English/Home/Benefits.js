          ...
          <div className="row benefits"  id="benefits">
            ...
            <div className="col-md-4">
              <div className="p-3 pr-5 text-center">
                ...
                <p className="text-center text-white">Increase compliance</p>
        ...
        <section className="container-fluid pt-5">
          <div className="row p-3 mt-5 color">
            <div className="col">
              ...
              <p className="text-center">Unburden your legal department</p>
            </div>
            <div className="col">
              <div className="text-center p-3">
                <img alt="simplify" src={require("../../../../images/simplify.png")} />
              </div>
              <p className="text-center">Focus on your core business and save a lot of time</p>
            </div>
            <div className="col">
              <div className="text-center p-3">
                <img alt="automate daily tasks" src={require("../../../../images/automate-daily-tasks.png")} />
              </div>
              <p className="text-center">Automate repetitive tasks and recurring legal questions</p>
            </div>
          </div>
        </section> 
        </>
