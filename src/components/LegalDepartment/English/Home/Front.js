    ...
    return (
        ...
        <div className="row">
          ...
          <div className="col-md-6 header">
            <h1 className="cover-heading pb-2">Legal AI Chatbots <br/> help lawyers <br/>work more efficient</h1>
            {/* <img src={require("../images/1.png")} className="logo" /> */}
            {/* <Typer/> */}
            <p className="lead">Lawren.io automates repetitive tasks in your law department</p>
            <p className="lead pt-4">
              <a href="#contact" className="btn btn-lg btn-light pl-5 pr-5"> Book a Demo </a>
              <Link to="/legaldepartment/usecase/en/" className="btn btn-lg btn-light">Usecases</Link>
            </p>
            {/* <p>*based on  law firms of 5 lawyers</p> */}
          </div>
          <div className="col-md-6 header">
            <Animation/>
          </div>
