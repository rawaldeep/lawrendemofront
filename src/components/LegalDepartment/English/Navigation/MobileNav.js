...
export default class MobileNav extends Component {
    ...
    render() {
        ...
        <Link to="/legaldepartment/en/#home" className="menu-item"> Home </Link>
        <Link to="/legaldepartment/en/#Features" className="menu-item">Features</Link>
        <Link to="/legaldepartment/en/#benefits" className="menu-item">Benefits</Link>
        <Link to="/legaldepartment/en/#team" className="menu-item">Team</Link>
        <Link to="/legaldepartment/en/#contact" className="menu-item">Contact</Link>
