    ...
    let useCaseLoop = state.usecases.map((usecase, index) => {
        ...
        <div className="item-box-blog d-flex">
          ...
          <div className="col-md-6 item-box-blog-body">
            ...
            <Link to={`/legaldepartment/usecase/nl${usecase.id}`}>
            ...
            <div className="mt">  <Link to={`/legaldepartment/usecase/nl/${usecase.id}`} className="btn read">Read more...</Link> 
            </div>
            {/*Read More Button*/}
          </div>
        </div>
        ...
        return (
          ...
          <div className="container">
              <h3 className="display-1 text-center p-5 mt-4">Geen usecases</h3>
          </div>
           <Footer/>
           </>
        )
