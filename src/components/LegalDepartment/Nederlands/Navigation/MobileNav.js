...
export default class MobileNav extends Component {
    ...
    render() {
        ...
        <Link to="/legaldepartment/nl/#home" className="menu-item"> Home </Link>
        <Link to="/legaldepartment/nl/#Features" className="menu-item">Features</Link>
        <Link to="/legaldepartment/nl/#benefits" className="menu-item">Benefits</Link>
        <Link to="/legaldepartment/nl/#team" className="menu-item">Team</Link>
        <Link to="/legaldepartment/nl/#contact" className="menu-item">Contact</Link>
