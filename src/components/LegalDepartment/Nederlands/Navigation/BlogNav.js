      ...
      <NavbarToggler onClick={this.toggleNavbar} className="mr-2" />
          <Collapse isOpen={!this.state.collapsed} navbar className="d-flex justify-content-end">
            <Nav id="#navbarNavDropdown">
              <NavItem>
                <Link to="/legaldepartment/nl" className="nav-link"> Home </Link>
              </NavItem>
              <NavItem>
                <NavLink href="/legaldepartment/nl/#Features">Kenmerken</NavLink>
              </NavItem>
              <NavItem>
                <NavLink href="/legaldepartment/nl/#benefits">Voordelen</NavLink>
              </NavItem>
              <NavItem>
                <NavLink href="legaldepartment/nl/#team">Team</NavLink>
              </NavItem>
              <NavItem>
                <NavLink href="/legaldepartment/nl/#contact">Contact</NavLink>
              </NavItem>
              <NavItem>
                <Link to="/legaldepartment/blog/nl" onClick={this.handleChange} className="nav-link"> Blog </Link>
              </NavItem>
              <NavItem>
                <Link to="/legaldepartment/FAQ/nl" onClick={this.handleChange} className="nav-link"> FAQ </Link>
              </NavItem>
              {/* <NavItem>
              <Link className="nav-link calculate" to="/legaldepartment/nl/#calculate">Bereken uw voordelen</Link>
              </NavItem> */}
