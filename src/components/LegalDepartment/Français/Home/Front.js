    ...
    return (
        ...
        <div className="row">
          ...
          <div className="col-md-6 header">
            ...
            {/* <Typer/> */}
            <p className="lead">Lawren.io automatise les tâches répétitives dans votre service juridique</p>
            <p className="lead pt-4">
              <a href="#contact" className="btn btn-lg btn-light pl-5 pr-5"> Réservez la démo </a>
              <Link to="/legaldepartment/usecase/en/" className="btn btn-lg btn-light">Usecases</Link>
            </p>
