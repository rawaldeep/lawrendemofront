           ...
           <div className="col-md-4">
            ...
            <div className="col-md-8 p-5">
              <div className="line pb-4">
                <h2 className="text-white">Calculez votre rendement</h2>
              </div>
              <p className="lead text-white">Remplissez le formulaire ici en dessous et calcule le nombre d’<strong>heures à gagner</strong> et combien de <strong>revenus supplémentairesvous</strong> pouviez générer</p>
            </div>
              ...
              <form className="container">
                <div className="form-row d-flex justify-content-between">
                  <div className="col-md-3 box p-4 card">
                    <p className="text-center">Nombre de nouveaux clients par mois</p>
                  ...
                  <div className="col-md-3 box p-4 card">
                    <p className="text-center"> <span style={{color: 'rgba(84, 100, 113, 0.5)'}}>Si applicable</span><br />
                    Nombre de nouveaux contrats par mois</p>
                    <div className="card-body">
                      <button type="button" id="moins" 
                      name="contracts"
                    onClick={clientMinus}
                  ...
                  <div className="col-md-6 box p-4 card">
                    <p className="text-center">Prix par heure</p>
                    <div className="card-body">
                      <div className="col">
                ...
                <div className="form-row pt-3 pb-3">
                  <div className="col-md-8 companyData">
                    <div className="form-row"><input type="text" placeholder="Nom de la compagnie" name="company" onChange={handleInputChange} value={state.company}/></div>
                    <div className="form-row"><input type="text" placeholder="Email Adresse" name="email" onChange={handleInputChange} value={state.email} /></div>
                  </div>
                  ...
                  <span className="personalizedreport">Recevez votre rapport personnalisé</span>
              </button>
