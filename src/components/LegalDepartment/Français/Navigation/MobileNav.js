...
export default class MobileNav extends Component {
    ...
    render() {
        ...
        <Link to="/legaldepartment/fr/#home" className="menu-item"> Home </Link>
        <Link to="/legaldepartment/fr/#Features" className="menu-item">Features</Link>
        <Link to="/legaldepartment/fr/#benefits" className="menu-item">Benefits</Link>
        <Link to="/legaldepartment/fr/#team" className="menu-item">Team</Link>
        <Link to="/legaldepartment/fr/#contact" className="menu-item">Contact</Link>
