      ...
      <NavbarToggler onClick={this.toggleNavbar} className="mr-2" />
          <Collapse isOpen={!this.state.collapsed} navbar className="d-flex justify-content-end">
            <Nav id="#navbarNavDropdown">
              <NavItem>
                <Link to="/legaldepartment/fr" className="nav-link"> Accueil </Link>
              </NavItem>
              <NavItem>
                <NavLink href="/legaldepartment/fr/#Features">Caractéristiques</NavLink>
              </NavItem>
              <NavItem>
                <NavLink href="/legaldepartment/fr/#benefits">Avantages</NavLink>
              </NavItem>
              <NavItem>
                <NavLink href="legaldepartment/fr/#team">Équipe</NavLink>
              </NavItem>
              <NavItem>
                <NavLink href="/legaldepartment/fr/#contact">Contact</NavLink>
              </NavItem>
              <NavItem>
                <Link to="/legaldepartment/blog/fr" onClick={this.handleChange} className="nav-link"> Blog </Link>
              </NavItem>
              <NavItem>
                <Link to="/legaldepartment/FAQ/fr" onClick={this.handleChange} className="nav-link"> FAQ </Link>
              </NavItem>
              {/* <NavItem>
